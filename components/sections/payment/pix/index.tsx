...
export function PixComponent() {
  ...
  async function handleSubmit({ cpf }: PixProps) {
    ...
    try {
      ...
      const responsePix = await api.post("/checkout/payment", {
      ...
      push({
        ...
        query: {
          name: user?.name,
          pixURL: responsePix?.data?.qrCode,
          pixImage: responsePix?.data?.qrCodeUrl,
          pixValor: responsePix?.data?.amount
        },
      });
    } catch (err) {
      setLoading(false);
