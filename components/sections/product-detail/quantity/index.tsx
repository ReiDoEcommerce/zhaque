...
interface QuantityProps {
    product: Product;
    AddProductInCart(): Promise<void>
}

export function Quantity({ product, AddProductInCart }: QuantityProps) {
    const { state, SubtractQuantity, AddQuantity, cartLoading } = useCart();
    ...
    return (
        <>
                ...
                <div className="quantity-total">
                    ...
                    <div className="quantity">
                        <button
                            ...
                            onClick={() => SubtractQuantity(thisItemInCart || thisProduct, 1)}
            ...
            <div className="actions">
                <button type="button" className="add-to-cart paragraph-1-bold" onClick={AddProductInCart} disabled={cartLoading}>
                    <span>
                    ...
                    <span>{thisItemInCart && (ToMoney(thisItemInCart.quantity * product.preco))}</span>
                </button>
            </div>
        </>
    )
